    ...
    return (
        <div className="min-h-screen flex w-full font-sans bg-white">
            ...
            <div className="hidden lg:flex lg:w-[60%] bg-gradient-to-br from-primary to-secondary relative overflow-hidden items-center justify-center">
                ...
                <div className="relative z-10 text-white p-12 max-w-2xl flex flex-col items-center text-center">
                    <div className="flex flex-col items-center gap-8 mb-12">
                        <img
                            src="/images/logo-motocare.png"
                            alt="Motocare Logo"
                            className="w-96 h-96 object-contain rounded-[3rem] bg-white/5 backdrop-blur-sm p-4"
                        />
                        <h1 className="text-4xl font-bold tracking-[0.2em] uppercase">Motocare</h1>
                    </div>

                    <p className="text-center text-white/80 text-lg leading-relaxed max-w-lg">
